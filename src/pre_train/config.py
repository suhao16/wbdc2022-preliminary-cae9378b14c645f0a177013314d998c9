...
def parse_args():
    ...
    parser.add_argument('--batch_size', default=56, type=int, help="use for training duration per worker")
    ...
    parser.add_argument('--pre_model', type=str, default='save/pretrain_model/best_pretrain_roberta_base.bin')
    ...
    # ========================= Learning Configs ==========================
    parser.add_argument('--max_epochs', type=int, default=34, help='How many epochs')
    parser.add_argument('--max_steps', default=500000, type=int, metavar='N', help='number of total epochs to run')
    ...
    parser.add_argument('--bert_dir', type=str, default='/home/test/liuluyao/wxy/model/chinese-roberta-wwm-ext')

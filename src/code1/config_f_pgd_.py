...
def parse_args():
    ...
    parser.add_argument("--seed", type=int, default=2022, help="random seed.") # 原来是2022 
    parser.add_argument('--dropout', type=float, default=0.3, help='dropout ratio')

    # ========================= Data Configs ==========================
    # parser.add_argument('--train_annotation', type=str, default='../challenge-main/data/annotations/labeled.json')
    parser.add_argument('--train_annotation', type=str, default='data/annotations/labeled.json')
    # parser.add_argument('--train_annotation', type=str, default='data/annotations/unlabeled.json')
    # parser.add_argument('--test_annotation', type=str, default='data/annotations/test_a.json')     # A榜
    parser.add_argument('--test_annotation', type=str, default='data/annotations/test_b.json')       # B榜
    parser.add_argument('--train_zip_feats', type=str, default='data/zip_feats/labeled.zip')
    # parser.add_argument('--train_zip_feats', type=str, default='data/zip_feats/unlabeled.zip')
    # parser.add_argument('--test_zip_feats', type=str, default='data/zip_feats/test_a.zip') # A榜
    parser.add_argument('--test_zip_feats', type=str, default='data/zip_feats/test_b.zip')       # B榜
    parser.add_argument('--test_output_csv', type=str, default='data/result_fintue.csv')
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='src/code1/save')
    parser.add_argument('--ckpt_file', type=str, default='save/v1/best_model.bin')
    # parser.add_argument('--pre_model', type=str, default='../challenge-main/save/pretrain_model/best_pretrain_roberta_base_Epoch33_step546414_loss0.31313.bin')  # 预训练模型加载地址
    parser.add_argument('--pre_model', type=str, default='src/code1/save/best_pretrain_roberta_base.bin')  # 预训练模型加载地址

    # parser.add_argument('--ckpt_file', type=str, default='save/v1/model_epoch_2_mean_f1_0.642.bin')
    ...
    parser.add_argument('--print_steps', type=int, default=300, help="Number of steps to log training metrics.")
    ...
    # parser.add_argument("--weight_decay", default=0.95, type=float, help="Weight deay if we apply some.")
    parser.add_argument("--adam_epsilon", default=1e-6, type=float, help="Epsilon for Adam optimizer.")

    # ========================== Title BERT =============================
    # parser.add_argument('--bert_dir', type=str, default='hfl/chinese-macbert-base')
    # parser.add_argument('--bert_dir', type=str, default='/src/code1/roberta/chinese-roberta-wwm-ext')
    parser.add_argument('--bert_dir', type=str, default="hfl/chinese-roberta-wwm-ext")      # 若在线下载chinese-roberta-wwm-ext出错则使用上方本地调用的代码
    # parser.add_argument('--bert_dir', type=str, default='/home/test/liuluyao/wxy/match/dspfl/baseline_qq/input/pretrain-model/roberta-wwm-large')
    # parser.add_argument('--bert_cache', type=str, default='data/cache')
    parser.add_argument('--bert_cache', type=str, default='data/cache_roberta')
    # parser.add_argument('--bert_cache', type=str, default='data/cache_roberta_large')

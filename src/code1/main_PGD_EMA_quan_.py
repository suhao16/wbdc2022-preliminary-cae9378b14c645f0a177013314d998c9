...
from fintue_data_480_tw_bu_fc_quan_ import create_dataloaders
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(f"src/code1/log_file/train_EMA_PGD_quan_480_bs32_lr5e-5_{time.strftime('%m%d_%H%M', time.localtime())}.log"),
...
def train_and_validate(args):
    ...
    for epoch in range(args.max_epochs):
        ...
        if mean_f1 > best_score:
            ...
            torch.save({'epoch': epoch, 'model_state_dict': model.module.state_dict(), 'mean_f1': mean_f1},
                       f'{args.savedmodel_path}/Best_EMA_PGD_480_bs32_lr5e-5_preepoch33_quan.bin')
